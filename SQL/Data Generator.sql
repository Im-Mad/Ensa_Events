...
INSERT INTO events (date,name,description,cover_photo,club_id) VALUES ('2021-11-08','Club Meeting','A meeting to know each others !','default.png',1);
INSERT INTO events (date,name,description,cover_photo,club_id) VALUES ('2021-11-08','Movie Partie','Let\'t watch a movie all together !','default.png',1);
INSERT INTO events (date,name,description,cover_photo,club_id) VALUES ('2021-11-08','Let\'s Code','Coding Party !','default.png',1);
INSERT INTO events (date,name,description,cover_photo,club_id) VALUES ('2021-11-08','Integration','A day to know new people !','default.png',1);

                        ...
                        <li class="nav-item">
                            <a class="nav-link p-0" href="${pageContext.request.contextPath}/user/me">
                                <img class="rounded-circle mx-4" height="40" width="40"
                                     src="${pageContext.request.contextPath}/assets/img/users/${user.avatar}">
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/login"
                               class="btn  btn-lg btn-outline-dark round btn-header" role="button"
                            ...
                            <div class="card-body p-md-5 mx-md-4 card-account">
                                ...
                                <form:form action="${pageContext.request.contextPath}/club/create" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:select path="username" items="${userNames}" class="form-control"
                                                     id="clubManager"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <c:if test="${registrationError != null }"><span
                                                class="form-error">${registrationError}</span></c:if>
                                    </div>
